...
public class PocketController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "포켓 생성 성공", content = @Content(schema = @Schema(implementation = PocketDTO.PocketSimpleInfoResponse.class)))})
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "자신이 속한 포켓 리스트 조회 성공", content = @Content(schema = @Schema(implementation = PocketDTO.PocketSimpleInfoListResponse.class)))})
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "포켓에 속한 유저 조회 성공", content = @Content(schema = @Schema(implementation = PocketDTO.PocketWithJoinUserResponse.class)))})
    @Operation(summary = "포켓에 속한 유저 리스트 조회", description = "포켓에 속한 유저 리스트를 조회 한다.")
    @SecurityRequirement(name = "Bearer Authentication")
    @GetMapping("/{pocketId}/users")
    @Permission
    private ResponseEntity<PocketDTO.PocketWithJoinUserResponse> getUserListByPocket(@Parameter(description = "pocket 의 id") @PathVariable Long pocketId) throws Exception {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "포켓 상세정보 조회 성공", content = @Content(schema = @Schema(implementation = PocketDTO.PocketDetailInfoResponse.class)))})
    @Operation(summary = "포켓 상세정보 조회", description = "포켓 상세정보를 조회 한다.")
    @SecurityRequirement(name = "Bearer Authentication")
    @GetMapping("/{pocketId}")
    @Permission
    private ResponseEntity<PocketDTO.PocketDetailInfoResponse> getPocket(@Parameter(description = "pocket 의 id") @PathVariable Long pocketId) throws Exception {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "포켓 탈퇴 성공", content = @Content(schema = @Schema(implementation = PocketDTO.PocketSimpleInfoResponse.class)))})
    @Operation(summary = "포켓 탈퇴", description = "포켓에서 탈퇴 한다.")
    @SecurityRequirement(name = "Bearer Authentication")
    @PatchMapping("/{pocketId}/leave")
    @Permission
    private ResponseEntity<PocketDTO.PocketSimpleInfoResponse> leavePocket(@AuthUser Users user, @Parameter(description = "pocket 의 id") @PathVariable Long pocketId) throws Exception {
        PocketDTO.PocketSimpleInfoResponse response = pocketService.leavePocket(user, pocketId);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "포켓에서 강퇴 성공", content = @Content(schema = @Schema(implementation = PocketDTO.PocketSimpleInfoResponse.class)))})
    ...
    private ResponseEntity<PocketDTO.PocketSimpleInfoResponse> banUserFromPocket(
            @AuthUser Users user,
            @Parameter(description = "pocket 의 id") @PathVariable Long pocketId,
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "포켓에 초대 성공", content = @Content(schema = @Schema(implementation = PocketDTO.InviteUserResponse.class)))})
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "링크를 사용한 포켓에 초대 성공", content = @Content(schema = @Schema(implementation = PocketDTO.InviteUserFromLinkResponse.class)))})
    @Operation(summary = "링크를 사용한 포켓에 초대", description = "유저가 링크를 타고 들어올 경우 로그인 진행 후 포켓에 초대를 한다.")
    @SecurityRequirement(name = "Bearer Authentication")
    @PostMapping("/invite-key/{pocketKey}")
    @Permission
    private ResponseEntity<PocketDTO.InviteUserFromLinkResponse> invitePocketFromLink(@AuthUser Users user, @Parameter(description = "pocket 의 key") @PathVariable("pocketKey") String pocketKey) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "포켓 초대 수락 성공", content = @Content(schema = @Schema(implementation = PocketDTO.acceptPocketInvitationResponse.class)))})
    @Operation(summary = "포켓 초대 수락", description = "포켓 초대를 수락 한다.")
    @SecurityRequirement(name = "Bearer Authentication")
    @PostMapping("/{pocketId}/accept")
    @Permission
    private ResponseEntity<PocketDTO.acceptPocketInvitationResponse> acceptPocketInvitation(@AuthUser Users user, @Parameter(description = "pocket 의 id") @PathVariable Long pocketId) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "포켓 이름 수정 성공", content = @Content(schema = @Schema(implementation = PocketDTO.PocketSimpleInfoResponse.class)))})
    ...
    private ResponseEntity<PocketDTO.PocketSimpleInfoResponse> updatePocket(@AuthUser Users user,
                                                                            @Parameter(description = "pokcet 의 id") @PathVariable Long pocketId,
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "포켓 방장 권한 위임 성공", content = @Content(schema = @Schema(implementation = PocketDTO.PocketWithJoinUserResponse.class)))})
    @Operation(summary = "포켓 방장 권한 위임", description = "포켓 방장 권한을 위임 한다.")
    @SecurityRequirement(name = "Bearer Authentication")
    @PatchMapping("/{pocketId}/master")
    @Permission
    private ResponseEntity<PocketDTO.PocketWithJoinUserResponse> updatePocketMaster(@AuthUser Users user, @Parameter(description = "pocket 의 id") @PathVariable Long pocketId, @RequestBody PocketDTO.UpdatePocketMasterRequest request) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "포켓별 초대를 수락하지 않은 유저 조회 성공", content = @Content(schema = @Schema(implementation = PocketDTO.NotAcceptPocketInviteUserResponse.class)))})
    @Operation(summary = "포켓별 초대를 수락하지 않은 유저 조회", description = "포켓별로 초대를 수락하지 않은 유저 리스트를 조회 한다.")
    @SecurityRequirement(name = "Bearer Authentication")
    @GetMapping("/{pocketId}/not-accept-invite")
    @Permission
    private ResponseEntity<PocketDTO.NotAcceptPocketInviteUserResponse> getAllNotAcceptInviteUser(@AuthUser Users user, @Parameter(description = "pocket 의 id") @PathVariable Long pocketId) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "초대를 수락하지 않았을 경우, 초대 취소 성공", content = @Content(schema = @Schema(implementation = PocketDTO.cancelInvitePocketResponse.class)))})
    ...
    private ResponseEntity<PocketDTO.cancelInvitePocketResponse> cancelPocketInvitation(
            @AuthUser Users user,
            @Parameter(description = "pocket 의 id") @PathVariable Long pocketId,
            @Parameter(description = "cancel user 의 id") @PathVariable Long cancelUserId
    ) {
